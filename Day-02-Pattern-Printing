...
#to print mirror right-angle triangle
n=int(input("Enter the size: "))
for i in range(n):
    for j in range(n):
...
# to print full right-angle triangle
'''n=int(input("Enter the size: "))
for i in range(n):
    for j in range(i):
        print("*",end=' ')   
...
# to print full inverted rightangled triangle
'''n=int(input("Enter the size: "))
...
# to print full symmetric right-angled triangle
n=int(input("Enter the size: "))
